                        ...
                        <div class="col-lg-6 justify-content-x mt-5 mb-4">
                            <div class="card card border-left-primary shadow h-100 py-2 mt-5" style="max-width: 600px;">
                                <div class="row no-gutters">
                                    <div class="col-md-4">
                                        <img src="<?= base_url('assets/img/profil/' . $user['gambar']) ?> " class="card-img rounded-circle" style="object-fit: cover; margin-left: 22px; margin-top: 22px; width: 125px; height: 125px;" alt="...">
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">
                                        ...
                                        <div class=" col-12 mt-3">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex justify-content-center gap-2">
                                                    ...
                                                    ?>
                                                    <!-- edit review -->
                                                    <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="prepareEditReview('<?= $reviewmodal; ?>','<?= $carsmodal ?>','<?= $reviewmodal1; ?>')">
